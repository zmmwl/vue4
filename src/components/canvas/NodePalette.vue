  ...
  <div class="node-palette">
    <div class="palette-search">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15.5 14H20.5L18 19H13L15.5 14ZM5.5 5L8 10H3L5.5 5ZM5.5 19L3 14H8L5.5 19ZM12 2L14.5 7H9.5L12 2ZM12 22L9.5 17H14.5L12 22Z" fill="#9aa0a6"/>
        <path d="M9.5 3C6.46 3 4 5.46 4 8.5C4 11.54 6.46 14 9.5 14C10.79 14 11.99 13.58 12.97 12.88L17.59 17.5L18.5 16.59L13.88 11.97C14.58 10.99 15 9.79 15 8.5C15 5.46 12.54 3 9.5 3ZM9.5 5C11.43 5 13 6.57 13 8.5C13 10.43 11.43 12 9.5 12C7.57 12 6 10.43 6 8.5C6 6.57 7.57 5 9.5 5Z" fill="#9aa0a6"/>
      </svg>
    ...
    <div class="palette-section">
      <div class="palette-section-title">Data Sources</div>
      <div
        class="palette-item"
        draggable="true"
        @dragstart="onDragStart($event, 'dataSource', 'database')"
      >
        <div class="palette-item-icon palette-icon-database">
        ...
        <div class="palette-item-info">
          <div class="palette-item-label">Database</div>
      ...
      >
        <div class="palette-item-icon palette-icon-api">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="palette-item-info">
          <div class="palette-item-label">HTTP Request</div>
          <div class="palette-item-description">Make API calls</div>
        </div>
      </div>
      <div
        class="palette-item"
      ...
      >
        <div class="palette-item-icon palette-icon-file">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 2H6C4.9 2 4.01 2.9 4.01 4L4 20C4 21.1 4.89 22 5.99 22H18C19.1 22 20 21.1 20 20V8L14 2ZM16 18H8V16H16V18ZM16 14H8V12H16V14ZM13 9V3.5L18.5 9H13Z" fill="currentColor"/>
          </svg>
        </div>
        <div class="palette-item-info">
          <div class="palette-item-label">Read File</div>
          <div class="palette-item-description">CSV, JSON files</div>
        </div>
      </div>
    </div>
    ...
    <!-- 计算任务节点 -->
    <div class="palette-section">
      <div class="palette-section-title">Privacy Computing</div>
      <div
        class="palette-item"
        draggable="true"
        @dragstart="onDragStart($event, 'taskNode', 'PSI')"
      >
        <div class="palette-item-icon palette-icon-psi">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="palette-item-info">
          ...
          <div class="palette-item-description">Private Set Intersection</div>
        </div>
      </div>
      <div
        class="palette-item"
      ...
      >
        <div class="palette-item-icon palette-icon-pir">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="palette-item-info">
          ...
          <div class="palette-item-description">Private Info Retrieval</div>
        </div>
      </div>
      <div
        class="palette-item"
      ...
      >
        <div class="palette-item-icon palette-icon-mpc">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="palette-item-info">
          ...
          <div class="palette-item-description">Multi-party Computation</div>
        </div>
      </div>
      <div
        class="palette-item"
      ...
      >
        <div class="palette-item-icon palette-icon-fl">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="palette-item-info">
          <div class="palette-item-label">Federated Learning</div>
          <div class="palette-item-description">Train models collaboratively</div>
        </div>
      </div>
    </div>
  </div>
